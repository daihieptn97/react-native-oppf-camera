...
//			 ChannelTitle.CONFIG_NAME,
	...
	public void onClick(View v) {
		...
		if (id == R.id.backBtnInTopLayout) {// 返回/退出
			finish();
		} else if (id == R.id.btnSwitchCameraFlip || id == R.id.btnSwitchCameraMirror || id == R.id.btnSwitchCameraOSD || id == R.id.btntimeSwitchCameraOSD || id == R.id.btnSwitchCameraAntiShake || id == R.id.btnSwitchCameraBLCMode || id == R.id.btnSwitchCameraWideDynamic) {
