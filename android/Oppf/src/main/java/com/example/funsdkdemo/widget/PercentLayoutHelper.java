 ...
 * implements
 * {@link com.mobile.myeye.widget.percent.PercentLayoutHelper.PercentLayoutParams}
 * .
...
public class PercentLayoutHelper {
	...
	private static boolean shouldHandleMeasuredHeightTooSmall(View view, PercentLayoutInfo info) {
		...
		return state == ViewCompat.MEASURED_STATE_TOO_SMALL && null != info.heightPercent
	...
	public static class PercentLayoutInfo {
		...
		public String toString() {
			return String.format("PercentLayoutInformation width: %f height %f, margins (%f, %f, " + " %f, %f, %f, %f)",
