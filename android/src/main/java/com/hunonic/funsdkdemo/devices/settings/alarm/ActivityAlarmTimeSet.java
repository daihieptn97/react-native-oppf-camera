...
public class ActivityAlarmTimeSet extends ActivityDemo
	...
	public boolean onButtonClick(ButtonCheck bc, boolean bChecked) {
		...
		if (id == R.id.alarm_setting_open) {
			...
			return true;
		} else if (id == R.id.alarm_setting_Repeat) {
			return true;
		} else if (id == R.id.alarm_setting_edit) {
	...
	public void onClick(View view) {
		...
		if (id == R.id.alarm_setting_date_rl) {
			...
			timeSelect = 1;
		} else if (id == R.id.alarm_setting_stop_time_rl) {
			...
			UpdateTimeUI(minute, hours);
			timeSelect = 2;
		} else if (id == R.id.alarm_setting_Label_rl) {
		...
		} else if (id == R.id.buttom_timepick) {// 点击布局消失
			hideButtomLayout();
		} else if (id == R.id.tv_sure) {
			setTime();
		} else if (id == R.id.tv_cancel) {
			hideButtomLayout();
		} else if (id == R.id.edit_rl) {
			mEditContent.setVisibility(mEditContent.getVisibility() == View.GONE ? View.VISIBLE : View.GONE);
