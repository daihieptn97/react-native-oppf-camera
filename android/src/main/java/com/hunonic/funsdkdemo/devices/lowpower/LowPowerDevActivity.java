package com.hunonic.funsdkdemo.devices.lowpower;
 ...
 * @author hws
 * @name OldFunSdkDemo
 * @class name：com.hunonic.funsdkdemo.devices.wakeup
...
public class LowPowerDevActivity extends ActivityDemo
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.backBtnInTopLayout) {
            finish();
        } else if (id == R.id.btnGetDeviceState) {
            showWaitDialog();
            FunSupport.getInstance().requestDeviceStatus(funDevice);
        } else if (id == R.id.btnDevWakeUp) {
        ...
        } else if (id == R.id.btnGetBatteryLevel) {
            if (!isReceiving) {
        ...
        } else if (id == R.id.iv_prompt_tone_switch) {
