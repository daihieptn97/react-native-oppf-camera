...
import com.hunonic.funsdkdemo.devices.tour.model.bean.ConfigGetPreset;
...
//                ,0);
    ...
    public void controlPreset(String cmd, int chn, int presetId, TourCallback callback) {
        ...
        if(cmd == OPPTZControlBean.SET_PRESET){
        ...
        FunSDK.DevCmdGeneral(userId
                ...
                , -1
                , 5000
                , HandleConfigData.getSendData(OPPTZControlBean.OPPTZCONTROL_JSONNAME, "0x08", bean).getBytes()
                , -1
                , 0);
        ...
        switch (msg.what) {
            ...
            case EUIMSG.DEV_CMD_EN: //处理“操作巡航线”、“操作预置点”
                ...
                switch (ex.str) {
                    ...
                    case OPPTZControlBean.SET_PRESET:
                    case OPPTZControlBean.TURN_PRESET:
                    case OPPTZControlBean.REMOVE_PRESET:
                    //以上回调目前均无需额外操作，统一处理
