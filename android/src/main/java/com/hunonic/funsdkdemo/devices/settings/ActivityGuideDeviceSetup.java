...
import com.hunonic.funsdkdemo.devices.settings.alarm.ActivityGuideDeviceSetupAlarm;
import com.hunonic.funsdkdemo.devices.settings.alarm.ActivityGuideDeviceSetupAlarmCenter;
import com.hunonic.funsdkdemo.devices.settings.intelligentvigilance.view.IntelligentVigilanceActivity;
import com.hunonic.funsdkdemo.devices.settings.other.ActivityDeviceOtherConfigGet;
import com.hunonic.funsdkdemo.devices.settings.pir.view.PirSetActivity;
import com.hunonic.funsdkdemo.devices.settings.remotectrl.view.DevRemoteCtrlActivity;
...
public class ActivityGuideDeviceSetup extends ActivityGuide {
	...
	protected void addDemoModules() {
		...
		//人形检测
		mGuideModules.add(new DemoModule(-1, R.string.human_detect,-1, IntelligentVigilanceActivity.class));
