package com.hunonic.funsdkdemo.devices.tour.presenter;
...
import com.hunonic.funsdkdemo.devices.tour.model.TourRepository;
...
import com.hunonic.funsdkdemo.devices.tour.model.bean.TourState;
...
public class TourPresenter implements TourContract.ITourPresenter{
    ...
    public void getTour() {
        ...
        dataSource.getTour(new SimpleTourCallback<List<PTZTourBean>>() {
            @Override
            public void onSuccess( List<PTZTourBean> ptzTourBeen) {
