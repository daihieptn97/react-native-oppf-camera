...
import static com.hunonic.funsdkdemo.R.id.img_setup_motion_move_btn;
import static com.hunonic.funsdkdemo.R.id.img_setup_outalarm_open_btn;
import static com.hunonic.funsdkdemo.R.id.img_setup_screen_occlusion_btn;
import static com.hunonic.funsdkdemo.R.id.img_setup_server_open_btn;
import static com.hunonic.funsdkdemo.R.id.img_setup_system_abnormality_btn;
import static com.hunonic.funsdkdemo.R.id.img_setup_user_connect_btn;
import static com.hunonic.funsdkdemo.R.id.img_setup_video_dismiss_btn;
...
public class ActivityGuideDeviceSPVMNCfgJson extends ActivityDemo implements View.OnClickListener, IFunSDKResult {
	...
	public void onClick(View v) {
		...
		if (id == R.id.backBtnInTopLayout) {
			finish();
		} else if (id == R.id.img_setup_server_open_btn) {
