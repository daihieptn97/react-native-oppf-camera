...
import com.hunonic.funsdkdemo.dialog.AlarmPeriodDlg;
import com.hunonic.funsdkdemo.entity.TimeItem;
...
import static com.hunonic.funsdkdemo.dialog.AlarmPeriodDlg.REQUEST_CODE_SETTING_ALARM_TIME;
...
// 报警输入
		if (id == R.id.backBtnInTopLayout) {// 返回/退出
			finish();
		} else if (id == R.id.btnSwitchMotionDetection || id == R.id.btnSwitchMotionDetectionAlarmRecord || id == R.id.btnSwitchMotionDetectionAlarmCapture || id == R.id.btnSwitchMotionDetectionAlarmPushMsg || id == R.id.btnSwitchVideoBlock || id == R.id.btnSwitchVideoBlockAlarmRecord || id == R.id.btnSwitchVideoBlockAlarmCapture || id == R.id.btnSwitchVideoBlockAlarmPushMsg || id == R.id.btnSwitchLocalIOAlarm || id == R.id.btnSwitchLocalIOAlarmRecord || id == R.id.btnSwitchLocalIOAlarmCapture || id == R.id.btnSwitchAlarmOutStatus || id == R.id.btnSwitchLocalIOAlarmPushMsg) {
			v.setSelected(!v.isSelected());
		} else if (id == R.id.btnSave) {    // 保存
			trySaveAlarmConfig();
		} else if (id == R.id.rl_alarm_time) {
			alarmPeriodDlg.show();
		} else if (id == R.id.lsi_alarm_interval) {
			mLsiAlarmInterval.toggleExtraView();
		} else if (id == R.id.rl_alarm_sound) {
