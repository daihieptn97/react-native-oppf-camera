package com.hunonic.funsdkdemo.devices.playback;
...
import com.hunonic.funsdkdemo.adapter.DeviceCameraRecordFileAdapter;
import com.hunonic.funsdkdemo.adapter.DeviceCameraRecordTimeAdapter;
import com.hunonic.funsdkdemo.entity.DownloadInfo;
...
//        }
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        if (checkedId == R.id.rb_by_file) {
            byFile = true;
        } else if (checkedId == R.id.rb_by_time) {
            byFile = false;
        }
        mVideoView.stopPlayback();
        onSearchFile();
