...
import com.hunonic.funsdkdemo.R.id;
import com.hunonic.funsdkdemo.R.layout;
...
public class ActivityDeviceFishEyeInfo extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(layout.activity_device_fisheye_info);

		mTextInfo = (TextView)findViewById(id.txtInfo);

		mBtnBack = (ImageButton)findViewById(id.backBtnInTopLayout);
