...
import com.basic.G;
import com.hunonic.funsdkdemo.ListAdapterFunDevice.OnFunDeviceItemClickListener;
import com.hunonic.funsdkdemo.alarm.ActivityGuideDeviceAlarmResult;
import com.hunonic.funsdkdemo.devices.ActivityGuideDeviceTransCom;
import com.hunonic.funsdkdemo.devices.lowpower.LowPowerDevActivity;
import com.hunonic.funsdkdemo.test.TestActivity;
...
public class ActivityGuideDeviceListLan extends ActivityDemo implements OnClickListener, OnFunDeviceListener, OnFunDeviceItemClickListener, OnAddSubDeviceResultListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.backBtnInTopLayout) {// 返回/退出
            finish();
        } else if (id == R.id.btnRefresh) {// 刷新设备列表
            requestToGetLanDeviceList();
        }
    }
    ...
    /* (non-Javadoc)
     * @see com.hunonic.funsdkdemo.ListAdapterFunDevice.OnFunDeviceItemClickListener#onFunDevice433Control(com.com.lib.funsdk.support.models.FunDevice)
     */
    @Override
...
//        }
    ...
    /* (non-Javadoc)
     * @see com.hunonic.funsdkdemo.ListAdapterFunDevice.OnFunDeviceItemClickListener#onFunDevice433AddSub(com.com.lib.funsdk.support.models.FunDevice)
     */
    @Override
