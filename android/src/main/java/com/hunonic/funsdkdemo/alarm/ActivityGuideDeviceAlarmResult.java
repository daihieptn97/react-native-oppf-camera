package com.hunonic.funsdkdemo.alarm;
...
import com.hunonic.funsdkdemo.ListAdapterDeviceAlarmInfo;
import com.hunonic.funsdkdemo.R;
import com.hunonic.funsdkdemo.devices.ActivityGuideDeviceLanAlarm;
...
public class ActivityGuideDeviceAlarmResult extends ActivityDemo implements OnClickListener,
	...
	public void onClick(View v) {
		...
		if (id == R.id.backBtnInTopLayout) {// 返回/退出
			finish();
		} else if (id == R.id.btnAlarmConfig) {
			startAlarmConfig();
		} else if (id == R.id.btnLanAlarmTest) {
			startLanAlarmTest();
		} else if (id == R.id.btnSelectDate) {
			showDatePicker();
		} else if (id == R.id.btnSwitchAlarmNotify) {
